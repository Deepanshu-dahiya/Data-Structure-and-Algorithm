...
I am going to use Map Data Structure for finding the union.
Time complexity is O(m+n)
We just need to insert element , as it store in key  value pair that's why unique element will be stored*/
